...
public class DaHuaController {
    ...
    @RequestMapping(value = "/method/snapCapture11", method = RequestMethod.POST)
    @ResponseBody
...
//            }
            ...
            boolean loginWithHighSecurity = daHuaCameraService.loginWithHighSecurity(ip, port, "username", "password");
