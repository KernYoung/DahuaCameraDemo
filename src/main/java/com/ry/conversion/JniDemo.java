...
////////////////////////////////////////////////////////////////
	...
	public void findRecognationInfo () {
		...
		file.stEndTime.dwMonth = 4;
		file.stEndTime.dwDay = 1;
		file.stEndTime.dwHour = 14;
		file.stEndTime.dwMinute = 59;
		file.stEndTime.dwSecond = 59;
		file.nAlarmType = 1;
        ...
        if (nRetCount <= 0) {
			System.err.println("FindNextFileEx failed!");
            break;
		} 
	...
	public void SetFaceDetectEnable() {
		 ...
		 * 
		 * String line = ""; while(true) { System.out.println("请输入通道号："); line =
		 * scanner.nextLine(); if(!line.equals("")) break; } scanner.close();
		 */
		long time = System.currentTimeMillis();
		...
		if(INetSDK.GetNewDevConfig( loginHandle, command , 0, szBuffer,nBufferLen,error,10000)) {
			...
			if(INetSDK.PacketData(command, analyse, szBuffer, bBufferLen))
	        {
	            ...
	            {	                
	                System.err.println("Set Config Failed!" + ToolKits.getErrorCode());
	            }
	        }
	        else
	        {
	            System.err.println("Packet Config Failed!" + ToolKits.getErrorCode());
	        }	       
	    }else {
   ...
   public void FindNextFileEx() {
	...
	private static class fAnalyzerDataCallBack implements CB_fAnalyzerDataCallBack {
		...
		public void invoke(long arg0, int arg1, Object arg2, byte[] arg3, int arg4, int arg5, int arg6) {
			...
			case FinalVar.EVENT_IVS_FACERECOGNITION:{
				...
				System.out.println("进入人脸识别，时间："+new String (facerecognitionInfo.szUID).trim());
				///////////////////////////////////////// 全景图
				///////////////////////////////////////// ////////////////////////////////////
			...
			case FinalVar.EVENT_IVS_FACEDETECT:{
				...
				System.out.println("进入人脸检测，时间："+new String (faceDetectInfo.szUID).trim());
	...
	public void RunTest() {
		...
		menu.addItem(new CaseMenu.Item(this , "FindNextFileEx" , "FindNextFileEx"));
