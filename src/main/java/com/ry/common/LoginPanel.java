...
public class LoginPanel extends JPanel {
	...
	public LoginPanel() {
		BorderEx.set(this, com.ry.common.Res.string().getLogin(), 2);
		setLayout(new FlowLayout());

		////////////////////////////////
		loginBtn = new JButton(com.ry.common.Res.string().getLogin());
		logoutBtn = new JButton(com.ry.common.Res.string().getLogout());
		ipLabel = new JLabel(com.ry.common.Res.string().getDeviceIp());
		portLabel = new JLabel(" " + com.ry.common.Res.string().getPort());
		nameLabel = new JLabel(" " + com.ry.common.Res.string().getUserName());
		passwordLabel = new JLabel(" " + com.ry.common.Res.string().getPassword());
	...
	public boolean checkLoginText() {
		if(ipTextArea.getText().equals("")) {
			JOptionPane.showMessageDialog(null, com.ry.common.Res.string().getInputDeviceIP(), com.ry.common.Res.string().getErrorMessage(), JOptionPane.ERROR_MESSAGE);
			return false;
		}
		
		if(portTextArea.getText().equals("")) {
			JOptionPane.showMessageDialog(null, com.ry.common.Res.string().getInputDevicePort(), com.ry.common.Res.string().getErrorMessage(), JOptionPane.ERROR_MESSAGE);
			return false;
		}
		
		if(nameTextArea.getText().equals("")) {
			JOptionPane.showMessageDialog(null, com.ry.common.Res.string().getInputUsername(), com.ry.common.Res.string().getErrorMessage(), JOptionPane.ERROR_MESSAGE);
			return false;
		}
		
		if(new String(passwordTextArea.getPassword()).equals("")) {
			JOptionPane.showMessageDialog(null, com.ry.common.Res.string().getInputPassword(), com.ry.common.Res.string().getErrorMessage(), JOptionPane.ERROR_MESSAGE);
			return false;
		}
